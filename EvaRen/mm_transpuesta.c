...
int main(int argc, char *argv[]) {
    ...
    int SZ = atoi(argv[1]);  // Convertir el primer argumento a entero para el tamaño de la matriz.
    int n_threads = atoi(argv[2]);  // Convertir el segundo argumento a entero para el número de hilos.
